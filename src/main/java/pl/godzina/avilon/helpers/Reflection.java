...
public class Reflection {
    ...
    public static Class<?> getMinecraftClass(final String name) {
        return getCanonicalClass(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(Reflection.NMS_PREFIX)))))) + "." + name);
    }

    public static Class<?> getCraftBukkitClass(final String name) {
        return getCanonicalClass(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(Reflection.OBC_PREFIX)))))) + "." + name);
    }
    ...
    private static String expandVariables(final String name) {
        ...
        while (matcher.find()) {
            ...
            if (replacement.length() > 0 && matcher.end() < name.length() && name.charAt(matcher.end()) != '.') {
                replacement = String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(replacement)))))) + ".";
            }
